...
PaginationUtil<ProductBean> paginationUtil = new PaginationUtil<>(products, pageSize);
...
List<ProductBean> currentPageProducts = paginationUtil.getCurrentPageData(pageNumber);
%>
