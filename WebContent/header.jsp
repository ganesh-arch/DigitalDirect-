...
<body style="background-color: #E6F9E6;">
    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.jsp" style="color: white;"><span class="glyphicon glyphicon-home">&nbsp;</span>DigitalDirect</a>
        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="login.jsp" style="color: white;">Login</a></li>
                <li><a href="register.jsp" style="color: white;">Register</a></li>
                <li><a href="index.jsp" style="color: white;">Products</a></li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color: white;">Category <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="index.jsp?type=mobile" style="color: black;">Mobiles</a></li>
                        <li><a href="index.jsp?type=tv" style="color: black;">TVs</a></li>
                        <li><a href="index.jsp?type=laptop" style="color: black;">Laptops</a></li>
                        <li><a href="index.jsp?type=camera" style="color: black;">Camera</a></li>
                        <li><a href="index.jsp?type=speaker" style="color: black;">Speakers</a></li>
                        <li><a href="index.jsp?type=tablet" style="color: black;">Tablets</a></li>
                    </ul>
                </li>
            </ul>
        </div>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="userHome.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>DigitalDirect</a>
			</div>
